...
public class HouseHold {
    ...
    public HouseHold(String code, String name) {
        this.id = null;
        this.code = code;
        this.name = name;
    }

    public HouseHold(String code, String name, Brand brand) {
        this.id = null;
        this.code = code;
        this.name = name;
        this.brand = brand;
    ...
    public HouseHold(String code, String name, Brand brand, Provider provider) {
        this.id = null;
        this.code = code;
        this.name = name;
        this.brand = brand;
