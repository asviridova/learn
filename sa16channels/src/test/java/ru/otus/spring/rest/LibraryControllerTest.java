...
public class LibraryControllerTest {
    ...
    private void initTestData(){
        shakespeare = new Author(1L, AUTHOR_SHAKESPEARE, "English");
        tragedy = new Genre(1L, GENRE_TRAGEDY);
        comedy = new Genre(1L, "comedy");
        otello = new Book(1L, BOOK_OTELLO, shakespeare, tragedy);
        otelloOptional =  Optional.of(otello);

        midsummer = new Book(2L, "Midsummer nights dream", shakespeare, comedy);
        ...
        given(genreService.getAll()).willReturn(expectedGenres);
    }
    ...
    public void  testSaveBook() throws Exception{
        mockMvc.perform(
                ...
                .andExpect(redirectedUrl("/"));
        verify(bookService, times(1)).update(1L, "New book", 1L, 1L);
