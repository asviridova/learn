...
public class Goods {
    ...
    public Goods(String code, String name, Double price, Integer quantity, GoodsType goodsType) {
        this.id = null;
        this.code = code;
        this.name = name;
        this.goodsType = goodsType;
    ...
    public Goods(String code, String name, String colour, String size, Integer quantity, Double price, GoodsType goodsType, Brand brand, Provider provider, Store store) {
        this.id = null;
        this.code = code;
        this.name = name;
        this.goodsType = goodsType;
