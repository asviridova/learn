...
CREATE TABLE GOODS(ID NUMERIC(18) PRIMARY KEY AUTO_INCREMENT, CODE VARCHAR(100) NOT NULL, NAME VARCHAR(255) NOT NULL, COLOUR VARCHAR(100), SIZE VARCHAR(20), PRICE NUMERIC(18,2) NOT NULL, GOODSTYPEID NUMERIC(18) NOT NULL, BRANDID NUMERIC(18), PROVIDERID NUMERIC(18) NOT NULL, STOREID NUMERIC(18));
